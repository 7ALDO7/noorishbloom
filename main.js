...
const languages = {
  ...
  es: {
    ...
    translations: {
      ...
      "products.bundleName": "#3 Dúo Nutritivo",
      "products.bundleDesc": "El par completo para el día de lavado: limpieza, acondicionamiento, suavidad y brillo.",
      "products.oilName": "#4 Aceite Fortalecedor para Cabello y Cuero Cabelludo",
